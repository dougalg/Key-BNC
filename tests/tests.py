...
class KeyBNCFileTests(TestCase):
    ...
    def testFileLoadOK(self):
        ...
        self.assertEqual(len(self.calculator.get_stats()), 4599)
        self.assertEqual(len(self.calculator.get_stats(for_words=['and'])), 1)
        self.assertEqual(len(self.calculator.get_stats(for_words=['and', 'a'])), 2)
    ...
    def testFileLoadBad(self):
        ...
        self.assertEqual(len(self.calculator.get_stats()), 0)
        self.assertEqual(len(self.calculator.get_stats(for_words=['the'])), 0)
        self.assertEqual(len(self.calculator.get_stats(for_words=['the', 'a'])), 0)
    ...
    def testDirLoad(self):
        ...
        self.assertEqual(len(self.calculator.get_stats()), 4601)
        self.assertEqual(len(self.calculator.get_stats(for_words=['be'])), 1)
        self.assertEqual(len(self.calculator.get_stats(for_words=['be', 'are'])), 2)
