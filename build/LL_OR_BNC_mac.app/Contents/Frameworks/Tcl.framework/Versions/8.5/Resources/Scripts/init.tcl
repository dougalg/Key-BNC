...
#
# ActiveState ActiveTcl 8.5.15.1.297588 OS X/Leopard/i386-x86_64, Sun Oct 27 20:55:21 PDT 2013
#
...
namespace eval ::activestate {
	...
	product       {ActiveTcl}
	release       {8.5.15.1}
	tcl,revision  {5e60d6ec24e7869f305d7e89ab17b329ce8997d2}
	tk,revision   {a615c82b6eb25f8c218a332eaa5a1353041406f7}
	maturity      {final}
	arch          {macosx10.5-ix86}
	buildtime,sec {1382932521}
	buildtime,fmt {Sun Oct 27 20:55:21 PDT 2013}
	as,mode       {normal}
    }
    ...
    variable  config
    array set config {
	{ActiveTcl} {ActiveState ActiveTcl 8.5.15.1.297588 OS X/Leopard/i386-x86_64 @ Sun Oct 27 20:55:21 PDT 2013 5e60d6ec24e7869f305d7e89ab17b329ce8997d2 / normal}
    }
}

package provide {ActiveTcl} {8.5.15.1.297588}
