use crate::stats::{dispersion, dispersion_normalized, log_likelihood, logdivision, odds_ratio};
...
fn ll_2() {
    assert_eq!(
        log_likelihood(200.0, 80_000.0, 2_546.0, 10_000_000.0),
        542.187_152_406_053_2
    )
}
...
fn odds_ratio_4_zero_adjustment() {
    assert_eq!(
        odds_ratio(12.0, 12.0, 100.0, 1_000.0, 0.5),
        224.004_975_124_378_12
    );
}
...
fn odds_ratio_5() {
    let ten: f64 = 10.0;
    assert_eq!(
        odds_ratio(1.0, 10_000_000.0, ten.powi(-9), 1_000_000_000_000.0, 0.0),
        100_000_010_000_000.98
    );
}
...
#[test]
fn dp_1() {
    let s_v = vec![(0.18, 1.0), (0.2, 2.0), (0.2, 3.0), (0.2, 4.0), (0.22, 5.0)];
    let f = 15.0;
